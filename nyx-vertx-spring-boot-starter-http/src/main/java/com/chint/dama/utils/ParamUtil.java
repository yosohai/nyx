...
public final class ParamUtil {
    ...
    public static JsonObject getRequestParams(RoutingContext ctx) {
        ...
        try {
            ...
            params.put("request", ctx.request());
            params.put("response", ctx.response());
            params.put("routingContext", ctx);
        ...
        if (params != null) {
            if (!params.containsKey("limit")) {
                ...
                if (params.getValue("limit") instanceof String) {
                    if (StringUtils.hasText(params.getString("limit"))) {
                        params.put("limit", 10);
                    } else {
            ...
            if (!params.containsKey("page")) {
                ...
                if (params.getValue("page") instanceof String) {
                    if (StringUtils.hasText(params.getString("page"))) {
                        params.put("page", 1);
                    } else {
