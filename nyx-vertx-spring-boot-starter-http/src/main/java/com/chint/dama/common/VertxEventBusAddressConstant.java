 ...
 *
 */
public interface VertxEventBusAddressConstant {
	/**
	 * 客户端启动所有应用于API,无参数要求<br>
	 * 结果:成功ok,500失败
	 */
    String CLI_START_EVERYTHING = "cli:startEverything";
	/**
	 * 客户端启动所有APP,无参数要求<br>
	 */
    String CLI_START_ALL_APP = "cli:startAllAPP";
	/**
	 * 客户端启动指定APP并同时启动所有的API,参数要求:JsonArray<br>
	 * ["网关应用的名字",...]<br>
	 * 结果:ok等于成功,其他为失败1400缺少参数,500错误
	 */
    String CLI_START_APP_EVERYTHING = "cli:startAPPEverything";
	/**
	 * 客户端启动指定APP,参数要求:JsonArray<br>
	 * ["网关应用的名字",...]<br>
	 * 结果:ok等于成功,其他为失败1400缺少参数,500错误
	 */
    String CLI_START_APP = "cli:startAPP";

	/**
	 * 查看系统运行情况,无需参数<br>
	 * 返回结果:500失败,其他成功
	 */
    String SYSTEM_GET_INFO = "sys:getSysInfos";
	/**
	 ...
	 * 没有返回结果
	 */
    String SYSTEM_PLUS_ERROR = "sys:plusError";
	/**
	 * 添加API追踪信息记录,参数要求:<br>
	 * [ to JsonObject
	 * 选填]<br>
	 * 没有返回结果
	 */
    String SYSTEM_PLUS_TRACK_INFO = "sys:plusTrackInfos";
	/**
	 * 查看API追踪信息记录,参数要求:JsonObject<br>
	 * [String 必填 ] appName 网关名字 , [String 必填 ] apiName API的名
	 */
    String SYSTEM_GET_TRACK_INFO = "sys:getTrackInfos";
	/**
	 * 更新IP地址,无需参数<br>
	 * 没有返回结果
	 */
    String SYSTEM_PUBLISH_BLACK_IP_LIST = "publish:updateBlackIpList";

	/**
	 * 查看黑名单ip地址,与SysVerticle交互,无需参数<br>
	 * 返回结果:失败500,其他成功
	 */
    String SYSTEM_BLACK_IP_FIND = "sys:findBlackIp";
	/**
	 * 更新黑名单ip地址,与SysVerticle交互,参数要求:JsonObject<br>
	 * [JsonArray 必填 ]ipList<br>
	 * 返回结果:失败:500,1400,1405,其他为成功
	 */
    String SYSTEM_BLACK_IP_REPLACE = "sys:replaceBlackIP";
	/**
	 * 添加请求到达VX的数量,无需参数,无返回
	 */
    String SYSTEM_PLUS_VX_REQUEST = "sys:requestVxApiCountPlus";
	/**
	 * 添加请求到达到达核心处理器(HTTP/HTTPS)的数量,无需参数,无返回
	 */
    String SYSTEM_PLUS_HTTP_API_REQUEST = "sys:requestHttpApiCountAndProcessingPlus";
	/**
	 * 减少核心处理器(HTTP/HTTPS)当前正在处理的数量,无需参数,无返回
	 */
    String SYSTEM_MINUS_CURRENT_PROCESSING = "sys:currentHttpApiProcessingCountMinus";

	/**
	 * 获取应用网关的数量,无需参数<br>
	 * 返回结果:JsonObject:app:网关应用的数量,api:API的数量
	 */
    String DEPLOY_APP_COUNT = "deploy:applicationCount";
	/**
	 * 部署应用程序,参数要求:JsonObject<br>
	 * [String 必填 ]appName网关名字,[JsonObject 必填 ]app网关配置信息<br>
	 * 结果:成功reply=ok,其他为失败
	 */
    String DEPLOY_APP_DEPLOY = "deploy:deployApplication";
	/**
	 * 卸载应用程序应用程序,参数要求:JsonObject<br>
	 * [String 必填 ]appName网关名字 , [String 选填 ]thisVertxName 集群环境时当前应用名字<br>
	 * 结果:ok成功,其他失败
	 */
    String DEPLOY_APP_UNDEPLOY = "deploy:undeployApplication";
	 ...
	 * 结果:JsonObject
	 */
    String DEPLOY_API_START_ALL = "deploy:startAllAPI";
	 ...
	 * 结果:1成功,其他失败:0,500
	 */
    String DEPLOY_API_START = "deploy:startAPI";
	/**
	 ...
	 * 结果:1成功,其他失败:500
	 */
    String DEPLOY_API_STOP = "deploy:stopAPI";

	/**
	 * 获得已部署的应用程序,无需参数<br>
	 * 结果:JsonArray
	 */
    String DEPLOY_FIND_ONLINE_APP = "deploy:findOnlineAPP";
	/**
	 * 查看APP是否已经部署,参数要求:String<br>
	 * 结果:Boolean
	 */
    String DEPLOY_APP_IS_ONLINE = "deploy:getAppIsOnline";
	/**
	 ...
	 * 结果:JsonArray
	 */
    String DEPLOY_FIND_ONLINE_API = "deploy:findOnlineAPI";
	/**
	 ...
	 * 结果:Boolean
	 */
    String DEPLOY_API_IS_ONLINE = "deploy:getApiIsOnline";
	 ...
	 */
    String APPLICATION_ADD_API_SUFFIX = "/:addRoute";

	/**
	 * 应用程序删除API的后缀,参数要求,String 必填 API的名字<br>
	 * 结果:成功=1,其他失败1400
	 */
    String APPLICATION_DEL_API_SUFFIX = "/:delRoute";

	/**
	 * 查看所有APP,无需参数
	 */
    String FIND_APP = "data:findApplication";
	/**
	 * 查看单个APP,参数要求:String
	 */
    String GET_APP = "data:getApplication";
	/**
	 * 添加APP,参数要求:JsonObject<br>
	 * [String 必填 ]appName 应用的名称, [JsonObject 必填] app 应用的属性<br>
	 * 返回结果:成功受影响行数,失败返回411,500
	 */
    String ADD_APP = "data:addApplication";
	/**
	 * 删除APP,参数要求:String<br>
	 * 结果:成功受影响行数,失败返回411,500
	 */
    String DEL_APP = "data:delApplication";
	/**
	 * 更新APP,参数要求:JsonObject<br>
	 * [String 必填 ]appName 应用的名称, [JsonObject 必填] app 应用的属性<br>
	 * 返回结果:成功受影响行数,失败返回411,500
	 */
    String UPDT_APP = "data:updtApplication";
	 ...
	 * 结果:失败返回411,500
	 */
    String FIND_API_ALL = "data:findAllAPI";
	 ...
	 * 结果:失败返回411,500
	 */
    String FIND_API_BY_PAGE = "data:findApiByPage";
	/**
	 * 查询单个API,参数要求:String<br>
	 * 结果:成功受影响行数,失败返回411,500
	 */
    String GET_API = "data:getAPI";
	/**
	 ...
	 * 结果:成功受影响行数,失败返回411,500
	 */
    String UPDT_API = "data:updtAPI";
	/**
	 * 更新黑名单列表,与DATAVerticle交互,无需参数
	 */
    String FIND_BLACKLIST = "data:findBlacklist";
	/**
