...
public class MysqlEventBusHandlerVertxEBProxy implements MysqlEventBusHandler {
  private Vertx _vertx;
  private String _address;
  private DeliveryOptions _options;
  private boolean closed;

  public MysqlEventBusHandlerVertxEBProxy(Vertx vertx, String address) {
    this(vertx, address, null);
  }

  public MysqlEventBusHandlerVertxEBProxy(Vertx vertx, String address, DeliveryOptions options) {
    this._vertx = vertx;
  ...
  public Future<JsonObject> getList(JsonObject jsonObject){
    ...
    _deliveryOptions.addHeader("action", "getList");
